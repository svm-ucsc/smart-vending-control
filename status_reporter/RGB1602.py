"""
RGB LCD1602 module for controlling the output of the display. Comes with functions for clearing,
setting the color of the display, and more. Module source from Waveshare.

Source: https://www.waveshare.net/w/upload/5/5b/LCD1602-RGB-Module-demo.zip
"""
